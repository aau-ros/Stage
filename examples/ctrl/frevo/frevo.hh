...
namespace frevo
{
    ...
    /**
     * Field of view of sensor in radian.
     */
    const double SENSOR_FOV = 2*PI;
    
    /**
     * Angular resolution of the sensor in radian.
     */
    const int SENSOR_RES = PI/4;

    /**
     * Range of sensor in grid cells.
     */
    const int SENSOR_RANGE = 1.5;
     ...
     */
    const string STATE_STRING[] = {"undefined", "init", "idle", "explore", "finished"};
