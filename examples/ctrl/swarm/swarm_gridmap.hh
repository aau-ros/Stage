#ifndef SWARM_GRIDMAP_H
#define SWARM_GRIDMAP_H
...
namespace swarm
{
    ...
    public:
        ...
        /**
         * Get the map origin, i.e. x and y offset.
         *
         * @return int*: Pointer to the two integer values.
         */
        int* Origin();
         ...
         * It is used for doing an A* search on the raster.
         *
        ...
        /**
         * Converts the local grid map into a uint8_t* where
         * 1 represents an occupied cell,
         * 0 represents a free cell, and
         * 9 represents an unknown cell.
         * It is used for log output.
         *
         * @return uint8_t*: The converted grid map.
         */
        uint8_t* Output();
    ...
    private:
        ...
        /**
         * The rasterized grid map for search.
         */
        uint8_t* raster;
        
        /**
         * The rasterized grid map for output.
         */
        uint8_t* output;
