#ifndef EAE_FREVO_SIMPLE_ROBOT_H
#define EAE_FREVO_SIMPLE_ROBOT_H

#include "eae_frevo_simple.hh"
#include "eae_frevo_simple_gridmap.hh"
...
/**
 * Namespace for energy aware exploration (eae) with frevo.
 */
